...
public class String_3 {
    ...
    // in a row. Return the number of triples in the given string. The 
    // triples may overlap.    
    ...
    // beginning and end of the given string. In other words, zero or more characters at the very begining of the given string, and at the very end of the string in reverse order (possibly overlapping). For example, the string "abXYZba" has the mirror end "ab". 
