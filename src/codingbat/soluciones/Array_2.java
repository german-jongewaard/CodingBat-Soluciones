...
public class Array_2 {
    ...
    //array, but rearranged so that all the zeros are grouped at the start of 
    ...
    //removed. The remaining elements should shift left towards the start 
    //of the array as needed, and the empty spaces a the end of the array 
    ...
    // Return an array that contains the exact same numbers as the given 
    array, but rearranged so that all the even numbers come before all the odd numbers. Other than that, the numbers can be in any order. You may modify and return the given array, or make a new array.        
